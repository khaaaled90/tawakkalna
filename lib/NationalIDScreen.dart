...
class _NationalIDScreenState extends State<NationalIDScreen> {
  ...
  final Map<String, String> leftData = {
    ...
    'تاريخ الاصدار/Date Issue': '14/07/2010',
    'تاريخ الانتهاء بالهجري/Expire Date in Hijri': '1457/07/01هـ',
    '': '',
  };

  final Map<String, String> rightData = {
    'الاسم/Name in Arsbic': 'رائد بن محمد بت ابراهيم ابراهيم',
    'مكان الميلاد/Place Of Pirrh': 'جده',
    'تاريخ الميلاد بالهجري/Date of': '1412/10/14هـ',
    'رقم الهوية بالانجليزي/ID Number io': '1082319755',
    'تاريخ الانتهاء/Expire Date': '03/08/2035',
    'نسخة/Copy': '5',
    //'': '',
  };
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container(height: 1, color: Colors.white24),
              const SizedBox(height: 4),
              _item('تاريخ الانتهاء بالميلادي', '03/09/2035'),
              Container(height: 1, color: Colors.white24),
              const SizedBox(height: 4),
